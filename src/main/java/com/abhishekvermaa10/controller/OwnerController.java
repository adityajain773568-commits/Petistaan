...
public class OwnerController {
    ...
    //    fetch owner details
    @GetMapping("/{ownerId}")
    public ResponseEntity<OwnerDTO> findOwner(@PathVariable Integer ownerId) throws OwnerNotFoundException {
    ...
    @PutMapping
    public ResponseEntity<Void> updatePetDetails(@RequestParam int ownerId, @RequestBody UpdatePetDTO updatedPetDTO) throws OwnerNotFoundException {
    ...
    public ResponseEntity<Void> deleteOwner(@PathVariable Integer ownerId) throws OwnerNotFoundException {
